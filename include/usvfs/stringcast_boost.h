...
class string_cast_impl<ToT, std::basic_string<CharT, Traits, Allocator>> {
  public:
    static ToT cast(const std::basic_string<CharT, Traits, Allocator>& source, CodePage codePage, size_t sourceLength) {
